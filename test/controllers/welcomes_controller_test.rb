...
class WelcomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post welcomes_url, params: { welcome: { content: @welcome.content, name: @welcome.name, title: @welcome.title } }
    end
  ...
  test "should update welcome" do
    patch welcome_url(@welcome), params: { welcome: { content: @welcome.content, name: @welcome.name, title: @welcome.title } }
